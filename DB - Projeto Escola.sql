...
CREATE TABLE Turma_Disciplinas (
  ...
  FOREIGN KEY (id_turma_disciplina) REFERENCES Turmas (id_turma),
  FOREIGN KEY (id_turma_disciplina) REFERENCES Disciplinas (id_disciplina)
  );
...
CREATE TABLE Turma_Alunos (
  ...
  FOREIGN KEY (id_turma_alunos) REFERENCES Alunos (id_aluno)
  );
...
--- Tabela Turma_Alunos
/***** ERROR ******
table "Turma_Alunos" has more than one primary key
 ----- 
CREATE TABLE Turma_Alunos (
...
--- Tabela Turma_Alunos
/***** ERROR ******
unknown column "id_turma_alunos" in foreign key definition
 ----- 
CREATE TABLE Turma_Alunos (
  id_tur INT,
  id_alu INT,
...
--- Consultas
/***** ERROR ******
no such column: valor
 ----- 
SELECT * FROM Alunos ORDER BY nome_aluno;
SELECT * FROM Disciplinas WHERE carga_horaria_disciplina > 40;
SELECT * FROM Notas WHERE valor_nota > 6 AND valor;
*****/
